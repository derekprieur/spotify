...
import {upsertPriceRecord, upsetProductRecord, manageSubscriptionStatusChange, } from '@/libs/supabaseAdmin'
        ...
        try {
            switch(event.type) {
                ...
                case 'product.updated':
                    await upsetProductRecord(event.data.object as Stripe.Product)
                    break
                case 'price.created':
                case 'price.updated':
